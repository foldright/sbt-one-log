# sbt-one-log plugin [![Build Status](https://travis-ci.org/CSUG/sbt-one-log.svg?branch=0.1.3.GA)](https://travis-ci.org/CSUG/sbt-one-log)](https://travis-ci.org/CSUG/sbt-one-log)
